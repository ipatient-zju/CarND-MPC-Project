      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          Eigen::Map<Eigen::VectorXd> waypoints_x_(ptrx, 6);
          Eigen::Map<Eigen::VectorXd> waypoints_y_(ptry, 6);

          auto coeffs = polyfit(waypoints_x_, waypoints_y_, 3);
		  ...
		  for (int k = 0; k < 100; k += 3){
            ...
            next_y_vals.push_back(polyeval(coeffs, k));
          }
